...
% 注入電流を変えたときの結果
On the other hand, because the gain recovery time varies due to the power of current injection, it is necessary to investigate on the effect on power of current injection to the proposed AND gate. Fig.{\ref{fig:different_pump_current}} shows the extinction ratios under different current injection. This result shows the extinction ratio is improving with increasing current injection because pattern-effect is decreasing.

\begin{figure}[htbp]
\begin{center}
  \includegraphics[width=70mm]{and_gate.eps}
  \caption{Extinction ratio under different current injection}
